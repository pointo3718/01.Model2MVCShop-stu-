...
<% 
	...
	System.out.println("jspVO"+purchaseVO);
%>
...
<table width="600" border="0" cellspacing="0" cellpadding="0"	align="center" style="margin-top: 13px;">
	...
	<tr>
		...
		<td class="ct_write01"><%=purchaseVO.getBuyerId().getUserId()%></td>
		<input type="hidden" name="buyerId" value="<%=purchaseVO.getBuyerId().getUserId()%>"/>
	</tr>
	<tr>
		<td height="1" colspan="3" bgcolor="D6D6D6"></td>
	</tr>
